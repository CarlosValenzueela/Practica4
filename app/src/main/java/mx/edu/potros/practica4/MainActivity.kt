...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val alturaE: EditText = findViewById(R.id.edEstatura)
        ...
        calcular.setOnClickListener(){
            ...
            try {
                ...
                imc.setText("Debe ingresar valores correctos")
                print(e)
            }
    ...
    fun calcularIMC(kilos:Double, estatura:Double): Double{
        return kilos / (estatura * estatura)
    }
}